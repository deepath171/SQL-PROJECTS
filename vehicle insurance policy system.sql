...
--- PROJECT : MOTOR INSURANCE POLICY SYSTAM 

CREATE DATABASE VEHICLE_POLICY;
USE VEHICLE_POLICY;

--- DDL & DML OPERATIONS Table structure for table `vehicle_make`
...
---
--- table structure for 'broker-info'
---
...
(6, 'Devi', 'Sita Brokers Pvt Ltd', '123 Main St', '1ST FLOOR', 'Delhi', 'Delhi', '9876543210', 'sita@brokers.com', 'active','2020-03-03', 'admin'),
...
(11, 'Rahul Nair', 'Nair Brokers', '45 Market Road', '1ST FLOOR', 'Kochi', 'Kerala', '7654321098', 'rahul@nair.com', 'active','2020-03-03', 'admin'),
(12, 'Meena Shah', 'Shah Insure Ltd', '11 Hill View', '1ST FLOOR', 'Ahmedabad', 'Gujarat', '6543210987', 'meena@shah.com', 'active','2020-03-03','admin'),
(13, 'Arvind Rao', 'Rao Secure', '5A West End', '3RD FLOOR', 'Bangalore', 'Karnataka', '5432109876', 'arvind@rao.com', 'active','2020-03-03','admin'),
(14, 'Devika R', 'D Secure', 'Building 7', '4TH FLOOR', 'Chennai', 'Tamil Nadu', '4321098765', 'devika@dsecure.com', 'inactive','2020-03-03', 'admin'),
(15, 'Gopi Krishnan', 'GK Covers', '3 East Lane', '2ND FLOOR', 'Hyderabad', 'Telangana', '3210987654', 'gopi@gk.com', 'active','2020-03-03','admin'),
(16, 'Nisha P', 'NP Associates', '98 Sunset Ave', 'GROUND FLOOR', 'Pune', 'Maharashtra', '2109876543', 'nisha@np.com', 'active','2020-03-03','admin'),
(17, 'Mahesh Y', 'Yadav Insure', 'Apt 12', '7TH FLOOR', 'Jaipur', 'Rajasthan', '1098765432', 'mahesh@yadav.com', 'active','2020-03-03', 'admin'),
(18, 'Sundar M', 'SM Protectors', 'Block D', '1ST FLOOR', 'Coimbatore', 'Tamil Nadu', '9988776655', 'sundar@sm.com', 'active','2020-03-03','admin');

select * from broker_info;

---
--- TABLE STRUCTURE FOR LOV_MASTER
---
...
---
--- DUMPING DATA FOR LOV_ MASTER
---
INSERT INTO lov_master VALUES
(1,'M', 'SINGLE','APP101', 'active', '2022-09-08'),
(2,'F', 'MARRIED', 'APP102', 'active', '2022-09-08'),
(3,'F', 'Single', 'APP103', 'active', '2022-09-08'),
(4,'M', 'Married', 'APP104', 'active', '2022-09-08'),
(5,'M','SINGLE','APP105', 'active', '2022-09-08'),
(6,'F', 'SINGLE','APP106', 'active', '2022-09-08'),
(7,'F', 'MARRIED','APP107', 'active', '2022-09-08'),
(8,'M', 'SINGLE','APP108', 'active', '2022-09-08'),
(9,'M', 'MARRIED','APP109', 'active', '2022-09-08'),
(10,'F','SINGLE','APP110', 'active', '2022-09-09');
...
---
--- table structure for 'premium_config'
---
...
---
--- dumping data for 'premium_config'
---
...
---
--- table structure for 'broker_user_info'
---
...
select * from broker_user_config;


---
--- table structure for 'premium_rate_config'
---
...
---
--- dumping data for table 'premium_rate_config'
---
...
---
--- table sturucture for 'quote_info_captured'
---
...
---
--- dumping data for table 'quote_info_captured'
---
...
---
--- table structue for 'broker_commission'
---
...
(1, 6, 'Comprehensive', 'Standard', 10.00, '2024-01-01'),
...
---
--- table structure for 'premium_calculated'
---
...
---
--- dumping data for table 'premium_calculated'
---
...
select * from personal_info where usertype="customer";

-- JOINS
-- using joins query for joining broker_commission table with broker_info
...
-- AGGREGATION QUERIES (FINDING THE AVERAGE PREMIUM  
SELECT 
...
-- SUB QUERY
-- to finding broker who earn more than the averagecommision
...
-- STORED PROCEDURE
-- get all quotes by a specific user
...
--trigger to prevent inserting broker without email
-- this enforces that brokers cannot be inserted without an email address
...
-- order by
-- oreder premium rate config by vehicle category then GST %
